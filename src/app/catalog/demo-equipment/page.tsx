...
export default function DemoEquipmentPage() {
  ...
  const subcategories = [
    { id: 'board-accessories', name: 'Аксессуары для досок', count: 18 },
    { id: 'badges', name: 'Бейджи и держатели для бейджей', count: 12 },
    { id: 'presentation', name: 'Презентационное оборудование', count: 15 }
  ];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Профессиональное оборудование для презентаций и обучения</p>
      </div>
        ...
        <div className="w-full lg:w-1/4">
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <div className="space-y-2">
              ...
              >
                <span className="font-medium">Все оборудование</span>
