...
export default function BookmarksPage() {
  ...
  const subcategories = [
    { id: 'plastic', name: 'Пластиковые закладки', count: 30 },
    { id: 'paper', name: 'Бумажные закладки', count: 25 },
    { id: 'magnetic', name: 'Магнитные закладки', count: 20 },
    { id: 'special', name: 'Специальные закладки', count: 15 }
  ];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Закладки</h1>
        <p className="text-gray-600 mt-2">Красивые и функциональные закладки для книг</p>
      </div>
