...
export default function SchedulesPage() {
  ...
  const subcategories = [
    { id: 'all', name: 'Все расписания уроков', count: 30 },
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Расписания уроков</h1>
        <p className="text-gray-600 mt-2">Расписания уроков и планировщики для школьников</p>
      </div>
        ...
        <div className="w-full lg:w-1/4">
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <div className="space-y-2">
              ...
              >
                <span className="font-medium">Все расписания уроков</span>
