...
const ART_GROUP_TITLE = 'Товары для творчества';
...
export default async function ArtCategoryPage({ params, searchParams }: PageProps) {
  ...
  const sidebarItems = getCatalogItemsByGroupTitle(ART_GROUP_TITLE);
  const currentPath = `/catalog/art/${slug}`;
