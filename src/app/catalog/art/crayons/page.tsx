...
export default function CrayonsPage() {
  const [selectedSubcategory, setSelectedSubcategory] = useState<string | null>(null);

  const subcategories = [
    { id: 'all', name: 'Все восковые мелки', count: 47 },
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Восковые мелки</h1>
        <p className="text-gray-600 mt-2">Яркие восковые мелки для детского творчества</p>
      </div>
        ...
        <div className="w-full lg:w-1/4">
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <div className="space-y-2">
              ...
              >
                <span className="font-medium">Все восковые мелки</span>
