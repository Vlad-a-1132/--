...
export default function StaticNotesPage() {
  ...
  const subcategories = [
    { id: 'magnetic', name: 'Магнитные блоки', count: 15 },
    { id: 'static', name: 'Статические блоки', count: 10 },
    { id: 'special', name: 'Специальные блоки', count: 8 }
  ];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Блок статический (магнитный)</h1>
        <p className="text-gray-600 mt-2">Удобные блоки для заметок с магнитным креплением</p>
      </div>
