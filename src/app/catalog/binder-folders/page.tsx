...
export default function BinderFoldersPage() {
  const [selectedSubcategory, setSelectedSubcategory] = useState<string | null>(null);

  const subcategories = [
    { id: 'standard', name: 'Стандартные папки-скоросшиватели', count: 30 },
    { id: 'premium', name: 'Премиум папки-скоросшиватели', count: 20 },
    { id: 'special', name: 'Специальные папки-скоросшиватели', count: 15 }
  ];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Надежные папки с пружинным механизмом для документов</p>
      </div>
